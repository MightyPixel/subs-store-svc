...
public class SubscriptionChangedReader implements ConsumerRebalanceListener, ConsumerAware {
  ...
  public void subscriptionChanged(
          ConsumerRecord<String, SubscriptionChangedMessage> record,
          KafkaAcknowledgement acknowledgement) {
